...
plot_single_vs_multipoint <- function(data, xy_lim) {
  ...
  readr::write_excel_csv(d_assays_filt, file = here(paste0("manuscript/output/Fig2_sourcedata.csv")))
...
readr::write_excel_csv(d_assays_filt, file = here(paste0("manuscript/output/Fig3_sourcedata.csv")))
...
readr::write_excel_csv(d_plot_1, file = here(paste0("manuscript/output/Fig4_sourcedata_points.csv")))
readr::write_excel_csv(d_sum_1, file = here(paste0("manuscript/output/Fig4_sourcedata_statistics.csv")))
...
d_plot_stats <- d_plot_norm_istd_mp |> 
  ...
  readr::write_excel_csv(d_plot_norm_istd_mp, file = here(paste0("manuscript/output/", "Fig5", "sourcedata_points.csv")))
  readr::write_excel_csv(d_plot_stats, file = here(paste0("manuscript/output/", "Fig5", "sourcedata_statistics.csv")))

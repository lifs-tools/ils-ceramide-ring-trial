...
readr::write_excel_csv(d_assays_plot, file = here(paste0("manuscript/output/Fig4A_sourcedata.csv")))

d_assays_filt <- flag_outlier(d_assays, limit_iqr = limit_iqr) |> filter(!Outlier_mp)
d_assays_filt$SampleType <- forcats::fct_relevel(d_assays_filt$SampleType, c("SRM","hTAG","DB","YAA")) 
p_Fig3B <- plot_all_refmaterials(d_assays_filt, xy_lim = c(0.7, 0.25, 9, 3))
readr::write_excel_csv(d_assays_filt, file = here(paste0("manuscript/output/Fig4B_sourcedata.csv")))
...
readr::write_excel_csv(get_fig4_stats(d_assays_plot), file = here(paste0("manuscript/output/Fig4A_sourcedata_statistics.csv")))
readr::write_excel_csv(get_fig4_stats(d_assays_filt), file = here(paste0("manuscript/output/Fig4B_sourcedata_statistics.csv")))
```
